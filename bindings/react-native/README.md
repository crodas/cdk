...
import { NativeOutputDataCreator, isNativeAvailable } from '@cashu/cashu-native';
...
The low-level module is available too:
...
| `src/NativeOutputDataCreator.ts` | no | The cashu-ts integration |
