...
pub const ENV_KEYSET_ROTATION_ENABLED: &str = "CDK_MINTD_MINT_KEYSET_ROTATION_ENABLED";
pub const ENV_KEYSET_ROTATION_INTERVAL_SECONDS: &str =
    "CDK_MINTD_MINT_KEYSET_ROTATION_INTERVAL_SECONDS";
pub const ENV_KEYSET_REFRESH_INTERVAL_SECONDS: &str =
    "CDK_MINTD_MINT_KEYSET_REFRESH_INTERVAL_SECONDS";
