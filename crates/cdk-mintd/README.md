...
- `[signatory].keyset_rotation_interval_seconds = 7776000` (or
  `CDK_MINTD_SIGNATORY_KEYSET_ROTATION_INTERVAL_SECONDS=7776000`): rotate active
  keysets once they are 90 days old.
